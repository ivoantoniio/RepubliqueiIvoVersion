...
<footer className="bg-white dark:bg-gray-900 border-t dark:border-none">
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Republiquei</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Nossa Marca</a>
                </li>
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Precisa de Ajuda?</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Servidor no Discord</a>
                </li>
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Baixa já!</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
    ...
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://www.republiquei.com">Republiquei</a>. Todos direitos reservados.
        </span>
